...
Use the [PROMPT-generate-markdown-files-v0.md](PROMPT-generate-markdown-files-v0.md) prompt to create your project documentation.
...
2. Paste contents of [SYSTEM-INSTRUCTIONS-v0.md](SYSTEM-INSTRUCTIONS-v0.md)
3. Save

### Step 3: Start Your Project
Use the [PROMPT-start-your-project-in-v0.md](PROMPT-start-your-project-in-v0.md) as your first message to v0
...
- [SYSTEM-INSTRUCTIONS-v0.md](SYSTEM-INSTRUCTIONS-v0.md) - v0 custom instructions (1,638 chars)
- [PROMPT-generate-markdown-files-v0.md](PROMPT-generate-markdown-files-v0.md) - Generate project docs
- [PROMPT-start-your-project-in-v0.md](PROMPT-start-your-project-in-v0.md) - Build instruction prompt
